...
class Ninja_Forms {
    ...
    private function setup_constants() {
        ...
        if ( ! defined( 'NF_PLUGIN_VERSION' ) )
            define( 'NF_PLUGIN_VERSION', '2.9.30' );
    ...
    public function get_plugin_settings() {
      ...
      $settings['req_div_label'] = isset ( $settings['req_div_label'] ) ? $settings['req_div_label'] : sprintf( __( '', 'ninja-forms' ), '<span class="ninja-forms-req-symbol">','</span>' );
